...
__webpack_require__(/*! ./app/suppliers */ "./resources/js/app/suppliers.js");
      ...
      success: function success(data) {
        if (data.error) {
          $.each(data.message, function (key, value) {
            $("#alertCompanies").children("span").text(value);
          });
...
$(document).on("turbolinks:load", function () {
  ...
  $("#suppliersFormBtn").on("click", function (e) {
    ...
    $.ajax({
      ...
      beforeSend: function beforeSend() {
        $(".loader").show();
        $(".loader").removeClass("d-none"); // $("#suppliersFormBtn").setAttribute("disabled", "disabled");
      },
      success: function success(data) {
        if (data.error) {
          $.each(data.message, function (key, value) {
            $("#alertSuppliers").children("span").text(value[0]);
          });
