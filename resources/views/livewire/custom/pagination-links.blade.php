    ...
    <div class="d-flex justify-content-center">
        ...
        <nav class="mt-2">
            <ul class="pagination" role='navigation'>
                ...
                <li class="page-item">
                    <a class="page-link" href="javascript:void(0)" wire:click='gotoPage(1)'>1</a>
                </li>
                @endif
                ...
                @if($i >= $paginator->currentPage() - 1 && $i <= $paginator->currentPage() + 1)
                    ...
                    @if($paginator->currentPage() < $paginator->lastPage() - 2)
                        ...
                        @if($paginator->currentPage() < $paginator->lastPage() - 1)
                            <li class="page-item">
                                <a class="page-link" href="javascript:void(0)" wire:click='gotoPage({{$paginator->lastPage()}})'>{{$paginator->lastPage()}}</a>
                            </li>
                            @endif
